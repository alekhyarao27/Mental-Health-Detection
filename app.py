...
emotions_emoji_dict = {"almosthomeless": "😠", "anxiety": "🤮", "assistance": "😨😱", "domesticviolence": "🤗", "food_pantry": "😂", "homeless": "😐", "ptsd": "😔", "relationships": "😔", "stress": "😳", "survivorsofabuse": "😮"}

# Main Application
def main():
    st.title("Mental Health Stress Classifier App")
    ...
    if choice == "Home":
        ...
        st.subheader("Mental Health Stress Classifier in Text")
